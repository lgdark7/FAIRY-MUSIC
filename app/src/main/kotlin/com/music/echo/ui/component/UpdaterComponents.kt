 ...
 * bold, italic, inline code, and interactive links with URL annotations.
 *
  ...
  for (match in matches) {
    ...
    when {
      ...
      match.groups[5] != null -> { // `code`
        builder.withStyle(SpanStyle(background = codeBgColor, fontFamily = FontFamily.Monospace)) {
